...
@section('content')
    ...
    <main id="main">
        ...
        <!--Section-3 Anderson Lane, Robbinsville, NJ 08691-->
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="Anderson-Lane-txt">
                             <h2>{{ $data[0] }}<small><a href="#">View on map</a> </small></h2>
                        </div>
                    </div>
                    <div class="col-lg-5">
            ...
            <div class="container-fluid">
                <div class="table100-nextcols table-responsive">
                    @if(array_key_exists('Applied',$data))
                            <p>OPEN PERMITS (<?php count($data['Applied']); ?>)</p>
                            <table>
                                <thead>
                                    <tr class="row100 head">
                                        ...
                                        <th class="cell100 column11">Total Cost</th>
                                    ...
                                    @if(!empty($data['Applied']))
                                        @foreach($data['Applied'] as $key => $value)
                                            <tr class="row100 body">
                                                ...
                                                <td class="cell100 column8">{{($value->PermitStatus=='complete')?'closed':'open'}}</td>
        ...
        <section class="table table-open-permits6 px-5">
            <div class="container-fluid">
                <div class="table100-nextcols table-responsive">
                    @if(array_key_exists('Closed with Date',$data))
                        <p>CLOSED PERMITS (<?php count($data['Closed with Date']); ?>)</p>
                        <table>
                            <thead>
                                <tr class="row100 head">
                                    <th class="cell100 column1"></th>
                            ...
                            <tbody>                           
                                @if(!empty($data['Closed with Date']))
                                    @foreach($data['Closed with Date'] as $key => $value)
                                        <tr class="row100 body">
                                            <td class="cell100 column1"></td>
                                            <!-- <td class="cell100 column2">36940</td> -->
                                            <td class="cell100 column3">{{$value->PermitNumber}}</td>

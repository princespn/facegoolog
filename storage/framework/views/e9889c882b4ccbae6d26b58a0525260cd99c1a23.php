...
<?php echo $__env->make('includes.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <section class="<?php echo e((isset($_GET['getcredits']) && $_GET['getcredits']==='yes')?'show':'hide'); ?>">
        <?php echo $__env->make('includes.popup-sections', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;    
    </section>    
    </main>
<?php echo $__env->make('includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php if(\Session::get('usePermit') == 0 && (\Session::get('viewReportPopUp') != 'yes' || \Session::get('PermitRequestData') != null)): ?>
    <section class="popup-already-account view-report-popup top-popup-background display-no-credits-popup <?php echo e((isset(Auth::guard('web')->user()->id) && \Session::get('PermitRequestData')!= null && \Session::get('usePermit')==0)?'show':'hide'); ?>">
...
<?php else: ?>
    ...
    <?php if( \Session::get('PermitRequestData') != null && \Session::get('usePermit')==0): ?>
        <section class="popup-already-account popup-account view-report-popup top-popup-background display-no-credits-popup <?php echo e((\Session::get('PermitRequestData')!= null && \Session::get('usePermit')==0)?'show':'hide'); ?>">
            <div class="popup-table">
                <div class="popup-view-report-txt">
                    <div class="view-report-txt">
                        <h2 style="text-align: center;">Alert!</h2>
    ...
    <?php elseif( \Session::get('PermitRequestData') != null && \Session::get('usePermit')>0): ?>
        <section class="popup-already-account popup-account top-popup-background view-report-popup display-yes-credits-popup <?php echo e((\Session::get('PermitRequestData')!= null)?'show':'hide'); ?>" id="">
            <div class="popup-table" id>
                <div class="popup-view-report-txt">
                    <div class="view-report-txt text-center">
                        <strong>Permit Request Payment</strong>
                    </div>
                    <p>For Permit Request, this will remove 1 credit from your account. You currently have <b><?php echo e(\Session::get('usePermit')); ?></b> <?php if( \Session::get('usePermit') > 1): ?> credits <?php else: ?> credit <?php endif; ?> remaining. On successful payment we will start Permit search process.
                    </p>
                </div>
                <div class="blue-bg-btn bg-white">
                    <a class="btn btn-effect" href="<?php echo e(url('/?permit=cancel')); ?>">Cancel</a> 
...
<?php /**PATH C:\xampp\htdocs\permitsearch\resources\views/index.blade.php ENDPATH**/ ?>
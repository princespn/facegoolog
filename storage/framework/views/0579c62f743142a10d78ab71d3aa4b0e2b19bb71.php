...
?>
<!--Section-table-popup-->
    <section class="popup-already-account pricePOPUP" id="priPopUp" style="display: none;" data-val="<?php echo e($flag); ?>">
        <div class="popup-table">
            <a href="<?php echo e(url('/?permit=cancel')); ?>" class="close-popup">&times;</a>
            <div class="popup-already-account-txt">
                ...
                <span id="SchooRESpan">
                    <?php if(Session::has('success')): ?>
                        <div class="alert alert-success">
                            1<?php echo e(Session::get('success')); ?>

                        </div>
                    <?php endif; ?>
                    <?php if(Session::has('ffail')): ?>
                        <div class="alert alert-danger">
                            3<?php echo e(Session::get('ffail')); ?>

                        </div>
                    <?php endif; ?>
                    <?php if(Session::has('fail')): ?>
                        <div class="alert alert-danger">
                            <?php echo Session::get('fail')->first('name', '<div class="error-block">:message</div>'); ?>

                            <?php echo Session::get('fail')->first('email', '<div class="error-block">:message</div>'); ?>

                            6<?php echo Session::get('fail')->first('password', '<div class="error-block">:message</div>'); ?>

                            <?php echo Session::get('fail')->first('stripeToken', '<div class="error-block">:message</div>'); ?>

                            <?php echo Session::get('fail')->first('priceIDVal', '<div class="error-block">:message</div>'); ?>
                ...
                <div class="popup-already-account-package">
                                ...
                                <div class="col-sm-6 p-0">
                                    <div class="package-txt">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="pricePlan" id="radio_<?php echo e($value->price); ?>" value="<?php echo e(Crypt::encrypt($value->id)); ?>" data-val="<?php echo e($value->price); ?>" <?php if($key == 0): ?>checked <?php endif; ?>>
                                        ...
                                        <ul>
                                            <li><i class="fa fa-circle"></i>$<?php echo e($value->price); ?></li>
                                            <li><i class="fa fa-circle"></i><?php echo e($value->report); ?></li>
                                            <li><i class="fa fa-circle"></i><?php echo e($value->description); ?></li>
                                        </ul>
                                        </label>
                                    </div>
                                </div> 
                    ...
                    <?php endif; ?>
                    <!-- <div class="annual-subscription">Annual Subscription Pricing | <a href="<?php echo e(url('/pricing')); ?>"> Learn more</a></div> -->
                </div>
            </div>
            <div class="blue-bg-btn" id="contAddress"><a class="btn btnn-effect" href="javascript:void(0)">
            <?php echo e((isset($_GET['getcredits']) && $_GET['getcredits']=='yes')?'Next':'Continue to Register'); ?></a> </div>
        </div>
    </section>
    ...
    <section class="popup-already-account popup-account accountPOPUP" style="display: none;">
        <div class="popup-table">
            <a href="javascript:void(0)" class="close-popup">&times;</a>
            <form method="POST" 
                action="<?php echo e(url('/register/account')); ?>" 
                role="form" 
                class="require-validation"
                data-cc-on-file="false"
                data-stripe-publishable-key="<?php echo e(config('app.STRIPE_KEY')); ?>"
                id="payment-form"
            >
                <?php echo csrf_field(); ?>
                <div class="popup-already-account-txt">
...
<!--Section-table-popup-End--><?php /**PATH C:\xampp\htdocs\permitsearch\resources\views/includes/popup-sections.blade.php ENDPATH**/ ?>